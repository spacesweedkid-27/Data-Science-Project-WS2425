...
\begin{column}{0.49\textwidth}
    ...
    What main chord repetition should you use to write the perfect song? We found the most frequently used harmonic progressions of the last 20 years, see figure \ref{fig:harmony}.\\
    ...
    \begin{figure}[hbt!]
        ...
        \caption{Top ten most used harmonic progressions by absolute frequency. Source: Webscraping of \textcite{ug}}
        \label{fig:harmony}
    \end{figure} 
    \end{block}
    \begin{block}{Chords}
    ...
    Looking at the top tags of the song we got from the \textcite{lastfm} and comparing to the identified harmonic progressions, we can see which genres use which chord progressions, see figure \ref{fig:harmtags}
    \begin{figure}[hbt!]
        \centering
        \includegraphics[width=\textwidth]{./figures/5.png}
        \caption{Top ten most frequent genre tags by how often they use a chord progression.}
        \label{fig:harmtags}
    \end{figure}
...
\end{column}
\end{columns}
\placetextbox{0.85}{0.125}{\qrcode[height=9cm]{https://fur-fortnite.onrender.com/}}
\placetextbox{0.015}{0.0275}{
    \tiny\color{bonewhite}
    References:
    \printbibliography
}
